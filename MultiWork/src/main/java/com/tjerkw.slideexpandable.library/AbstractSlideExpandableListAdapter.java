...
public abstract class AbstractSlideExpandableListAdapter extends WrapperListAdapterImpl {
	...
	*/
    ...
    private ActionSlideExpandableListView.OnActionItemClickListener clickListener;
    private ActionSlideExpandableListView.OnActionLongItemClickListener longItemClickListener;
		...
		button.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(final View view) {
                if(clickListener != null){
                    clickListener.onItemClick(parent, target, position);
                }
                if(((ActionSlideExpandableListView)parent).isActionModeEnabled()) return;
        ...
        button.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                if(longItemClickListener != null){
                    longItemClickListener.onLongItemClick(parent, target, position);
                }
                return true;
            }
        });
    ...
    public void setOnActionItemClickListener(ActionSlideExpandableListView.OnActionItemClickListener listener) {
        clickListener = listener;
    }

    public void setOnActionItemLongClickListener(ActionSlideExpandableListView.OnActionLongItemClickListener listener) {
